...
export function ReverseReveal({ declaredType, calculatedType, personaName }: Props) {
  ...
  return (
    ...
    >
      ...
      {isMatch ? (
        <div
          className={`rounded-2xl border border-type-${calculatedType} bg-surface-elevated shadow-[var(--shadow-e2)] p-5 text-center`}
        >
          <p className="text-slate-200 text-[14px] leading-relaxed mb-2">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="rounded-2xl border border-[var(--hairline)] bg-surface-elevated shadow-[var(--shadow-e1)] p-4 text-center opacity-70">
          ...
          <div className={`rounded-2xl border border-type-${calculatedType} bg-surface-elevated shadow-[var(--shadow-e2)] p-4 text-center`}>
            <p className="text-[11px] uppercase tracking-[0.15em] text-slate-400 mb-2">
              Thực ra
            </p>
