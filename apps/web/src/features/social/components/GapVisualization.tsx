          ...
          {!hasUnlockedGapReport && (
            <div className="absolute inset-0 flex items-center justify-center bg-black/30 backdrop-blur-[2px]">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white/10 hover:bg-white/15 text-white text-[14px] font-medium border border-white/20 cursor-pointer"
              >
